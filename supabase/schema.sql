...
(
  ...
  '/images/dus.svg',
  'Air mineral kemasan cup 220ml isi 48 cup per dus. Pilihan utama untuk toko bahan campuran, minimarket (Alfamart/Indomaret), dan toko grosir.',
  '220ml (48 Cup per Dus)',
  array['Isi 48 cup per dus (Kardus tebal)', 'Minimal pemesanan (MOQ): 10 Dus', 'Segel higienis anti-bocor & sedotan higienis', 'Cocok untuk stok dagangan toko & minimarket'],
  'Hubungi Admin untuk Harga Grosir',
  30000,
  true,
  true
),
